...
def run(data_path, log_top):
    ...
    model_uri = "runs:/{run_id}/{artifact_path}".format(run_id=best_run.info.run_id, artifact_path=best_run.info.artifact_uri)

    # register the best model
    mlflow.register_model( model_uri=model_uri, name="taxi_data_random_forest" )
